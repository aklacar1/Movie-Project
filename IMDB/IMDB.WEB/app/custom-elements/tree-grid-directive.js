        ...
        .run([
            ...
            function ($templateCache) {
                $templateCache.put('template/treeGrid/treeGrid.html',
                    ...
                    " <table class=\"table table-striped tree-grid\">\n" +
                    "   <thead>\n" +
                    "     <tr class=\"bg-warning\">\n" +
                    ...
                    "   </thead>\n" +
                    "   <tbody>\n" +
                    "     <tr class=\"bg-warning\" ng-repeat=\"row in tree_rows | searchFor:$parent.filterString:expandingProperty:colDefinitions:true track by row.branch.uid\"\n" +
        ...
        .filter('searchFor', function () {
            ...
            function checkItem(item, filterString, col) {
                if (col.sortingType === "number") {
                    ...
                    if (item.branch[col.field] != null
                        && item.branch[col.field].toString().toLowerCase().indexOf(filterString.toLowerCase()) !== -1) {
                        return true;
                    }
                }
            }
