...
namespace IMDB.API.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Register([FromBody]inUserModel model)
        {
            ...
            var user = new Users { UserName = model.UserName, Email = model.EMail,PersonId=null };
        ...
        {
            var returnValue = userService.InsertPerson(person);
        ...
        {
            var returnValue = userService.UpdatePerson(person);
            if (returnValue == null) return NotFound();
            return Ok(returnValue);
        }
        ...
        [Authorize(Roles = "SU")]
        public async Task<IActionResult> DeletePersonById([FromRoute]long id)
        {
            var returnValue = userService.DeletePersonById(id);
            if (returnValue == null) return NotFound();
            return Ok(returnValue);
        }
